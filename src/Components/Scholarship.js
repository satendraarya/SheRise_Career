    ...
    <header>
      ...
      <div className='schloarship'>
        ...
        <div className='scholarship-banner'>
          <img src='https://sherise.vercel.app/static/media/Donation.71edebfb86df5143bbaea0a1728642a7.svg' alt=''></img>
        </div>
      </div>
        ...
        <div className='scholarship-form'>
          ...
          <div className='sch-contactFormContainer'>
            <form>
              ...
              <label>
                <textarea name='message' rows="6" placeholder='Why you need this scholarship? Write in brief*' required></textarea>
              </label>
